...
class Hotel:
    ...
    def __init__(self,root):
        ...
        BottomFrame = Frame(MainFrame,bd=10, width=1350,height=550, padx=20, relief=RIDGE,bg="powder blue" )
...
#====fullname==========================
        ...
        self.lblCustomer_Ref =Label(LeftFrame, font=('arial', 12, 'bold'),text="Firstname",padx=2,bg="powder blue")
        ...
        self.lblCustomer_Ref =Label(LeftFrame, font=('arial', 12, 'bold'),text="Surname",padx=2,bg="powder blue")
...
#=====hhjhjh======
        ...
        self.cboNationality['value']=('','Indian','Iran','Canada','France','Norway','Kenya')
        ...
        self.cboIDType['value']=('','Aadhar Card','Passport','Driving License','Voter IDCard')
        ...
        self.txtCheck_In_date =Entry(LeftFrame,textvariable = CheckInDate, font=('arial', 12, 'bold'), width = 20)
        ...
        self.txtCheck_Out_date =Entry(LeftFrame, textvariable = CheckOutDate, font=('arial', 12, 'bold'), width = 20)
        ...
        self.cboRoomNo['value']=('','101','102','103','104','105','201','202','203','204','205')
        ...
        self.txtToatlCost = Entry(RightFrame,font=('arial', 14, 'bold'), textvariable=TotalCost, bd=7, bg="white",width=67)
        self.txtToatlCost.grid(row=5, column=1)  
